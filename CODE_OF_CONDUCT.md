...
Thank you for being a part of Project Shards. We value your participation and want everyone to have an enjoyable and fulfilling experience. Accordingly, all participants are expected to follow this Code of Conduct, and to show respect, understanding, and consideration to one another. Thank you for helping make this a welcoming, friendly community for everyone.

## Scope

This Code of Conduct applies to all Project Shards community spaces, including, but not limited to:

 * Issue tracking - Issues made on our Github repositories.
 * Code repositories - https://github.com/project-shards
 * Wikis - `To be added`
 * Chat and public forums - https://discord.gg/u9McaXUq2t
 * Community spaces hosted on our infrastructure
 * Any other channels or groups which exist in order to discuss Project Shards project activities
...
Communication channels and private conversations that are normally out of scope may be considered in scope if a Project Shards participant is being stalked or harassed. Social media conversations may be considered in-scope if the incident occurred under a Project Shards event hashtag, or when an official Project Shards account on social media is tagged, or within any other discussion about Project Shards. The Project Shards Core team reserves the right to take actions against behaviors that happen in any context, if they are deemed to be relevant to the Project Shards project and its participants.

All participants in Project Shards community spaces are subject to the Code of Conduct. This includes the Project Shards  members. This also includes volunteers, maintainers, leaders, contributors, contribution reviewers, issue reporters, Project Shards users, and anyone participating in discussion in Project Shards community spaces. For in-person events, this also includes all attendees, exhibitors, vendors, speakers, panelists, organizers, staff, and volunteers.

## Reporting an Incident

If you believe that someone is violating the Code of Conduct, or have any other concerns, please contact one of the Core team members on [our Discord server](https://discord.gg/u9McaXUq2t).

## Our Standards

The Project Shards community is dedicated to providing a positive experience for everyone, regardless of:
...
We want all participants in the Project Shards community have the best possible experience they can. In order to be clear what that means, we've provided a list of examples of behaviors that are inappropriate for Project Shards community spaces:
 ...
 * **Possession of an offensive weapon at a Project Shards event.** This includes anything deemed to be a weapon by the event organizers.

### Safety versus Comfort

The Project Shards community prioritizes marginalized people's safety over privileged people's comfort, for example in situations involving:
...
The examples listed above are not against the Code of Conduct. If you have questions about the above statements, please [read GNOME's document on Supporting Diversity]([supporting-diversity.md](https://gitlab.gnome.org/Teams/Conduct/gnome-code-of-conduct/-/blob/master/supporting-diversity.md)).
...
If a participant engages in behavior that violates this code of conduct, the Project Shards Core team may take any action they deem appropriate.

## Procedure for Handling Incidents

 * Reports shall be made through [email](shards@eryn.cloud), or as [Discord](https://discord.gg/u9McaXUq2t) DMs to one of the Core team member (see hoisted role).

 * Core team member will react approprietely.

## License

The Project Shards Code of Conduct is licensed under a [Creative Commons Attribution Share-Alike 3.0 Unported License](http://creativecommons.org/licenses/by-sa/3.0/)

[![Creative Commons License](http://i.creativecommons.org/l/by-sa/3.0/88x31.png)](http://creativecommons.org/licenses/by-sa/3.0/)

## Attribution

The Project Shards Code of Conduct was forked from the [GNOME Code of Conduct](https://wiki.gnome.org/Foundation/CodeOfConduct), which was forked from the example policy from the [Geek Feminism wiki, created by the Ada Initiative and other volunteers](http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy), which is under a Creative Commons Zero license.
